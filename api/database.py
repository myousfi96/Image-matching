...
# Collections are defined globally but populated by connect_to_mongo
...
def connect_to_mongo():
    ...
    # Example: ensure an index on product category for faster filtering
    products.create_index("category")
    print("MongoDB connected and collections initialized.")

# ---------------------------------------------------------------------------
# CRUD helpers – intentionally minimal
# ---------------------------------------------------------------------------

def add_product(name: str, category: str, price: float, image_url: str) -> str:
